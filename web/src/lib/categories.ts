...
const MATCHERS: (Category & { re: RegExp })[] = [
    ...
    { id: 'places',    label: 'Places & Directions', icon: MapPin,          color: '#E6A23C', re: /\b(place|places|location|where|city|directions?|street|country|town|travel|village)\b/ },
    { id: 'people',    label: 'People & Family',     icon: Users,           color: '#FF9EB5', re: /\b(family|friend|friends|people|relationship|person)\b/ },
    { id: 'being',     label: 'Being & Identity',    icon: Fingerprint,     color: '#E6A23C', re: /\b(identity|name|names|self|who|intro|ser|estar|being|gustar)\b/ },
...
export const DEFAULT_CATEGORY: Category = {
    id: 'grammar', label: 'Grammar', icon: BookOpen, color: '#F7F2E8',
}
