...
function LearnPlayer() {
    ...
    if (!code || !isLoaded || !isSignedIn) return <main className="flex min-h-dvh items-center justify-center bg-[radial-gradient(circle_at_50%_30%,rgba(255,122,61,.13),transparent_25rem),#09090a] p-6 text-ivory" role="status"><div className="text-center"><span className="ecla-loading-mark mx-auto block text-ember-soft" /><p className="font-display mt-5 text-2xl">Preparing your scene…</p><p className="mt-2 text-sm text-stone">Restoring your place and conversation.</p></div></main>
