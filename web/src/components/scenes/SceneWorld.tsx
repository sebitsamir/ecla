    ...
    return <div className="ecla-dark-scene relative min-h-[23rem] overflow-hidden bg-obsidian sm:min-h-[30rem] lg:min-h-[36rem]">
        ...
        <div className="relative flex min-h-[23rem] flex-col justify-between p-5 sm:min-h-[30rem] sm:p-8 lg:min-h-[36rem]">
            ...
            <div className="flex items-end justify-between gap-5">
                ...
                <div className="shrink-0 text-center"><div className="scene-character mx-auto flex size-16 items-center justify-center rounded-full border border-ember-soft/50 bg-obsidian/75 text-2xl font-medium text-ember-soft shadow-[0_0_36px_rgba(230,162,60,.2)] backdrop-blur-md sm:size-20 sm:text-3xl" aria-hidden>{person.initial}</div><p className="mt-2 max-w-28 truncate text-xs font-semibold text-ivory/80">{person.name}</p></div>
            </div>
        </div>
    </div>
}
